...
c1llu <- read.table("/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/C1_FDA_HT/50K/counts_hcc1395bl.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/C1_FDA_HT/10K/counts_hcc1395bl.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
...
sil_scran.c1fda<-silhouette(clusterd,dist.sce)
save(sil_scran.c1fda,file="/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/normal_BL/results/sil_scran.c1fda.RData")
...
sil_raw.c1fda<-silhouette(clusterd,dist.raw)
save(sil_raw.c1fda,file="/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/normal_BL/results/sil_raw.c1fda.RData")
### DESeq
...
sil_deseq.c1fda<-silhouette(clusterd,dist.deseq)
save(sil_deseq.c1fda,file="/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/normal_BL/results/sil_deseq.c1fda.RData")
...
clusterd <- rep(1:ncells,2)
sil_tmm.c1fda<-silhouette(clusterd,dist.tmm)
save(sil_tmm.c1fda,file="/sc/wo/tri_data/primary/2018_03_10XGenomics_SLE_whole_blood_MiSeq/biyx/FDA/subsampleing/normal_BL/results/sil_tmm.c1fda.RData")
