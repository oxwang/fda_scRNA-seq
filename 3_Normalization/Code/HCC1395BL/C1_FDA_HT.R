...
library(cluster)
library(Linnorm)
vloc<-"/.../3_Normalization/Results/HCC1395BL/"
dataid <- "c1fda"

c1llu <- read.table("/.../3_Normalization/Data/HCC1395BL/C1_FDA_HT/50K/counts_HCC1395BL.txt.gz",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/.../3_Normalization/Data/HCC1395BL/C1_FDA_HT/10K/counts_HCC1395BL.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
