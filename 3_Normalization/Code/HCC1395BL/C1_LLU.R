...
c1llu <- read.table("/.../3_Normalization/Data/HCC1395BL/C1_LLU/100K/counts_HCC1395BL.txt.gz",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/.../3_Normalization/Data/HCC1395BL/C1_LLU/10K/counts_HCC1395BL.txt.gz",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
