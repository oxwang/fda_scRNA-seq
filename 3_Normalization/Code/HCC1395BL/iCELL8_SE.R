...
c1llu <- read.table("/.../3_Normalization/Data/HCC1395BL/iCELL8/SE/10K/counts_HCC1395BL.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/.../3_Normalization/Data/HCC1395BL/iCELL8/SE/100K/counts_HCC1395BL.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
