...
c1llu <- read.table("/.../3_Normalization/Data/HCC1395/C1_FDA_HT/50K/counts_hcc1395.txt.gz",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/.../3_Normalization/Data/HCC1395/C1_FDA_HT/10K/counts_hcc1395.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
