...
c1llu <- read.table("/.../3_Normalization/Data/HCC1395/iCELL8/PE/10K/counts_hcc1395.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
c1llu2 <- read.table("/.../3_Normalization/Data/HCC1395/iCELL8/PE/100K/counts_hcc1395.txt",header=T,stringsAsFactors = FALSE,sep="\t", quote="")
