...
setwd('./FilteredNew/2dataset/CCA_sean-pcs/')
...
#Visualization
pdf('Post_alignment_TSNEPlotwith10PCs_Samples.pdf')
TSNEPlot(samples.integrated, group.by='sample')
dev.off()
pdf('Post_alignment_TSNEPlotwith10PCs.pdf')
...
samples.all <- FindClusters(object = samples.all, reduction.type = "cca.aligned", dims.use = 1:pcs[[1]],
                            save.SNN = TRUE)
pdf('No_discard_Post_alignment_TSNEPlotwith10PCs_Samples.pdf')
TSNEPlot(samples.all, group.by='sample')
dev.off()
pdf('No_discard_Post_alignment_TSNEPlotwith10PCs.pdf')
...
pdf('No_discard_Post_alignment_TSNEPlotwith10PCs_Samples_Legend.pdf')
...
pdf('No_discard_Post_alignment_TSNEPlotwith10PCs_Samples_NoLegend.pdf')
temp
dev.off()
