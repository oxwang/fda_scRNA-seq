...
setwd('FilteredNew/LLU_NCI/mnnCorrect/')
...
out <- mnnCorrect(assay(sce[[1]], "logcounts"),
                  ...
                  assay(sce[[5]], "logcounts"),
                  assay(sce[[6]], "logcounts"),
                  assay(sce[[7]], "logcounts"),
...
assay(sce[[5]], "mnnCounts") <- out$corrected[[5]]
assay(sce[[6]], "mnnCounts") <- out$corrected[[6]]
assay(sce[[7]], "mnnCounts") <- out$corrected[[7]]
...
print(plotTSNE(combined, colour_by = "Batch"))
dev.off()
