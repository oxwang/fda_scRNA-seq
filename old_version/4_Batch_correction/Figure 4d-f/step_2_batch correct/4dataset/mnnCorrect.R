...
batch <- c("10X_LLU_A", "10X_NCI_A", "10X_LLU_B", "10X_NCI_B")
...
LLU_Tumor <- CreateSeuratObject(gene_counts, project="10X_LLU_A")
LLU_Tumor@meta.data$sample <- "10X_LLU_A"
...
NCI_Tumor <- CreateSeuratObject(gene_counts, project="10X_NCI_A")
NCI_Tumor@meta.data$sample <- "10X_NCI_A"
...
LLU_Normal <- CreateSeuratObject(gene_counts, project="10X_LLU_B")
...
NCI_Normal <- CreateSeuratObject(gene_counts, project="10X_NCI_B")
NCI_Normal@meta.data$sample <- "10X_NCI_B"

setwd('FilteredNew/4dataset/mnnCorrect/')

merged <- MergeSeurat(LLU_Tumor, NCI_Tumor)
...
out <- mnnCorrect(assay(sce[[1]], "logcounts"),
                  ...
                  assay(sce[[3]], "logcounts"),
                  assay(sce[[4]], "logcounts"),
...
assay(sce[[3]], "mnnCounts") <- out$corrected[[3]]
assay(sce[[4]], "mnnCounts") <- out$corrected[[4]]
